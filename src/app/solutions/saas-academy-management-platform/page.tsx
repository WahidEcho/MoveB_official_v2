...
export const metadata = { title: "SaaS Academy Management Platform | Move Beyond" };

export default function SaaSAcademyPage() {
  const features = [
          ...
          <div>
            <nav aria-label="Breadcrumb" className="text-xs text-[var(--mb-muted)]">
              <ol className="flex gap-2">
                ...
                <li>/</li>
                <li aria-current="page" className="text-[var(--mb-text)]">SaaS Academy Management Platform</li>
              </ol>
            </nav>
            <h1 className="font-display text-4xl md:text-5xl font-bold mt-4 max-w-4xl">SaaS Academy Management Platform - Transforming Sports Operations</h1>
