...
export const metadata = { title:"Illusionaire VR Activation | Case Study", description:"Virtual Illusionaire — a festival you can explore, play, and perform in." };

export default function IllusionaireCase() {
  return (
    <main className="min-h-screen bg-[var(--mb-bg-0)] text-[var(--mb-text)]">
      <section className="relative py-20">
        ...
        <div className="container mx-auto px-6">
          <Breadcrumbs current="Illusionaire VR Activation" />
          <h1 className="font-display text-4xl md:text-6xl font-bold">Illusionaire VR Activation</h1>
          <p className="mt-4 text-lg text-[var(--mb-muted)] max-w-3xl">Virtual Illusionaire — a festival you can explore, play, and perform in.</p>
        </div>
      </section>

      <Section title="Client Profile">
        <p className="text-[var(--mb-muted)] max-w-3xl">Illusionaire gaming & pop‑culture festival; esports, anime, fan arts, music, and interactive sponsors.</p>
      </Section>
      ...
      <Section title="Solution — Virtual Illusionaire">
      ...
      <Section title="Gallery">
        <Gallery images={[
          {src:"/case-studies/insomnia/01.svg"}, {src:"/case-studies/insomnia/02.svg"},
          {src:"/case-studies/insomnia/03.svg"}, {src:"/case-studies/insomnia/04.svg"},
          {src:"/case-studies/insomnia/05.svg"}, {src:"/case-studies/insomnia/06.svg"},
          {src:"/case-studies/insomnia/07.svg"}, {src:"/case-studies/insomnia/08.svg"},
        ]}/>
      </Section>
