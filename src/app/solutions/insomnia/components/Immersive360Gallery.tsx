...
export default function Immersive360Gallery() {
  ...
  const images = [
    { src: "/case-studies/insomnia/01.svg", title: "Neural Awakening", description: "The journey begins as consciousness emerges from the depths of sleep" },
    { src: "/case-studies/insomnia/02.svg", title: "Digital Surveillance", description: "The cyber eye watches as reality bends and shifts around us" },
    { src: "/case-studies/insomnia/03.svg", title: "Portal Discovery", description: "Finding gateways between dimensions in the quantum realm" },
    { src: "/case-studies/insomnia/04.svg", title: "Holographic Manifestation", description: "Where thoughts become reality through digital projection" },
    { src: "/case-studies/insomnia/05.svg", title: "Neural Network", description: "Connecting minds across the digital consciousness grid" },
    { src: "/case-studies/insomnia/06.svg", title: "Quantum Cube", description: "Reality fractures into infinite probability states" },
    { src: "/case-studies/insomnia/07.svg", title: "AI Companion", description: "The robotic guide emerges to navigate the digital landscape" },
    { src: "/case-studies/insomnia/08.svg", title: "VR Transcendence", description: "Final ascension through virtual reality into infinite consciousness" }
  ];
